...
| **DSV4-Vision-Exp VL TP=2** | both Sparks over dual-rail RoCE | DeepSeek-V4-Flash-Vision-Exp, FP8 unstripped (snapshot `6821d6ad`, vision enabled) | same -ffn GLP-29 relabel, L10–38 at α=1.0 (day-0 tree keeps the deferred mHC fold → `ffn_out_pre_residual`) | **hardware-validated 2026-09-20/21 (2x DGX Spark, GB10)** — `recipe/dsv4vl/`; day-0 vLLM (0.28.1rc1 + PR #54566) on `vllm-upstream-vision:k2-topk512` (flashinfer 0.6.18 + DSV4 dual-prefill topk 192/256/512 backport, [msuiche/flashinfer](https://github.com/msuiche/flashinfer/tree/sm121-dsv4-prefill-topk512)); nospec; vision smoke green (image-token math, mix, text-only, concurrency) |
