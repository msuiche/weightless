# ---------------------------------------------------------------------------
# VENDORED — do not edit here; re-vendor from upstream instead.
#
# Source:   tonyd2wild/GLM-5.3-Flash-NVFP4-DFlash2-2x-DGX-Spark,
#           docker/sparse_attn_indexer_kpool_sm121.py (main branch)
# Author:   tonyd2wild (deployed and debugged by Knox / Claude)
# Fetched:  2026-08-30
#
# SM121 (GB10) sparse-attention indexer top-k fix. Both published upstream
# images (radixark/vllm-glm53-flash:sm121-v8 and
# ghcr.io/tonyd2wild/vllm-glm53-flash:sm121-v11-dflash2) hard-kill on decode
# past ~24K context unless this file is bind-mounted over the in-image
# vllm/model_executor/layers/sparse_attn_indexer_kpool.py on every node.
# Forensics: docs/SM121-CRASH-FORENSICS-2026-08-27.md in the source repo.
# ---------------------------------------------------------------------------
