#!/usr/bin/env python3
"""Local eval driver for the weightless-steer Qwen3.8-Flash-Next plugin test.
...
Usage:
    python3 eval_qwen38fn_plugin.py --base-url https://....modal.run --alpha 0.0
    python3 eval_qwen38fn_plugin.py --base-url https://....modal.run --alpha 1.0
"""
import argparse
import collections
...
OUT = os.path.join(HERE, "out-qwen38fn-plugin-test")
